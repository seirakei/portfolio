!(function (t) {
  ...
  var t = function (t) {
      var e;
      return function (i) {
        return e || t((e = { exports: {}, parent: i }), e.exports), e.exports;
      };
    },
    e = t(function (t, o) {
      t.exports = n;
    ...
    i = t(function (t, e) {
      ...
      (n.prototype.tangents = function (t, e) {
        ...
        if (i > 0) {
          ...
          var a = s;
          Math.abs(o.x) < 0.9
            ? (a.set(1, 0, 0), o.cross(a, t))
            : (a.set(0, 1, 0), o.cross(a, t)),
            o.cross(t, e);
    ...
    o = t(function (t, e) {
      ...
      (n.prototype.identity = function () {
        ...
        (n.prototype.transpose = function (t) {
          for (
            var e = (t = t || new n()).elements, i = this.elements, o = 0;
            3 !== o;
            o++
          )
  ...
  (a.prototype.setFromPoints = function (t, e, i, o) {
    var n = this.lowerBound,
      r = this.upperBound,
      s = i;
    n.copy(t[0]), s && s.vmult(n, n), r.copy(n);
    ...
    (m.prototype.toEuler = function (t, e) {
      ...
      switch (e) {
        case "YZX":
          ...
          if (
            (l > 0.499 &&
              ((i = 2 * Math.atan2(r, h)), (o = Math.PI / 2), (n = 0)),
            l < -0.499 &&
              ((i = -2 * Math.atan2(r, h)), (o = -Math.PI / 2), (n = 0)),
            isNaN(i))
          ) {
  ...
  (B.pointToLocalFrame = function (t, e, i, o) {
    return (o = o || new E()), i.vsub(t, o), e.conjugate(A), A.vmult(o, o), o;
  }),
    ...
    (B.pointToWorldFrame = function (t, e, i, o) {
      return (o = o || new E()), e.vmult(i, o), o.vadd(t, o), o;
    }),
  ...
  var F = C,
    ...
    q = z;
  function C(t, e, i) {
    M.call(this, { type: M.types.CONVEXPOLYHEDRON }),
      (this.vertices = t || []),
      (this.worldVertices = []),
  ...
  (C.prototype = new M()), (C.prototype.constructor = C);
  var N = new S();
  (C.prototype.computeEdges = function () {
    ...
    for (var o = N, n = 0; n !== t.length; n++)
      for (var r = t[n], s = r.length, a = 0; a !== s; a++) {
        var h = (a + 1) % s;
        e[r[a]].vsub(e[r[h]], o), o.normalize();
  ...
  (C.computeNormal = function (t, e, i, o) {
    e.vsub(t, R), i.vsub(e, T), T.cross(R, o), o.isZero() || o.normalize();
  }),
  ...
  C.prototype.clipAgainstHull = function (t, e, i, o, n, r, s, a, h) {
    for (
      var l = P, p = -1, u = -Number.MAX_VALUE, c = 0;
      c < i.faces.length;
      c++
    ) {
      l.copy(i.faceNormals[c]), n.vmult(l, l);
      var d = l.dot(r);
      d > u && ((u = d), (p = c));
    }
    for (var v = [], y = i.faces[p], f = y.length, m = 0; m < f; m++) {
      var w = i.vertices[y[m]],
        x = new S();
      x.copy(w), n.vmult(x, x), o.vadd(x, x), v.push(x);
    }
  ...
  C.prototype.findSeparatingAxis = function (t, e, i, o, n, r, s, a) {
    ...
    for (var b = 0; b !== this.uniqueEdges.length; b++) {
      ...
      for (var g = 0; g !== t.uniqueEdges.length; g++)
        if ((n.vmult(t.uniqueEdges[g], c), u.cross(c, d), !d.almostZero())) {
          d.normalize();
    ...
    return o.vsub(e, p), p.dot(r) > 0 && r.negate(r), !0;
  };
  var V = [],
    _ = [];
  C.prototype.testSepAxis = function (t, e, i, o, n, r) {
    C.project(this, t, i, o, V), C.project(e, t, n, r, _);
    var s = V[0],
      a = V[1],
      h = _[0],
      l = _[1];
  ...
  (C.prototype.clipFaceAgainstHull = function (t, e, i, o, n, r, s) {
    for (
      ...
      a.copy(this.faceNormals[x]), i.vmult(a, a);
      var b = a.dot(t);
      b < w && ((w = b), (m = x));
    }
    if (!(m < 0)) {
      ...
      for (var E = 0; E < this.faces.length; E++)
        for (var B = 0; B < this.faces[E].length; B++)
          -1 !== g.indexOf(this.faces[E][B]) &&
            E !== m &&
            -1 === g.connectedFaces.indexOf(E) &&
            g.connectedFaces.push(E);
      y.length;
      for (var z = g.length, A = 0; A < z; A++) {
        ...
        var C = q - v.dot(e);
        for (this.clipFaceAgainstPlane(y, f, v, C); y.length; ) y.shift();
      ...
      for (
        ...
        if (
          (N <= n &&
            (console.log("clamped: depth=" + N + " to minDist=" + n), (N = n)),
          N <= r)
        ) {
          var T = y[E];
          if (N <= 0) {
            var R = { point: T, normal: v, depth: N };
            s.push(R);
          }
        }
      }
    ...
    (C.prototype.clipFaceAgainstPlane = function (t, e, i, o) {
      ...
      n = i.dot(a) + o;
      for (var l = 0; l < s; l++) {
        if (((h = t[l]), (r = i.dot(h) + o), n < 0))
          if (r < 0) (p = new S()).copy(h), e.push(p);
          else {
            var p = new S();
            a.lerp(h, n / (n - r), p), e.push(p);
          }
        else
          r < 0 &&
            ((p = new S()), a.lerp(h, n / (n - r), p), e.push(p), e.push(h));
        (a = h), (n = r);
      }
      return e;
    }),
    (C.prototype.computeWorldVertices = function (t, e) {
      ...
      for (var o = this.vertices, n = this.worldVertices, r = 0; r !== i; r++)
        e.vmult(o[r], n[r]), t.vadd(n[r], n[r]);
    ...
    (C.prototype.computeWorldFaceNormals = function (t) {
      ...
      for (
        var i = this.faceNormals, o = this.worldFaceNormals, n = 0;
        n !== e;
        n++
      )
        t.vmult(i[n], o[n]);
  ...
  (C.prototype.calculateWorldAABB = function (t, e, i, o) {
    for (
      var n, r, s, a, h, l, p = this.vertices.length, u = this.vertices, c = 0;
      c < p;
      c++
    ) {
      $.copy(u[c]), e.vmult($, $), t.vadd($, $);
      var d = $;
      d.x < n || void 0 === n
        ? (n = d.x)
        ...
        d.z < s || void 0 === s
          ? (s = d.z)
          : (d.z > l || void 0 === l) && (l = d.z);
    }
    i.set(n, r, s), o.set(a, h, l);
  }),
  ...
  var rt = ht,
    ...
    at = i({});
  function ht(t) {
    st.call(this, { type: st.types.BOX }),
      (this.halfExtents = t),
  ...
  (ht.prototype = new st()),
    ...
    (ht.prototype.calculateLocalInertia = function (t, e) {
      return (
        (e = e || new at()), ht.calculateInertia(this.halfExtents, t, e), e
      );
    }),
  ...
  function yt(t) {
    (t = t || {}),
      ...
      (this.vlambda = new ct()),
      (this.collisionFilterGroup =
        "number" == typeof t.collisionFilterGroup ? t.collisionFilterGroup : 1),
      (this.collisionFilterMask =
  ...
  (yt.prototype = new d()),
    ...
    (yt.sleepyEvent = { type: "sleepy" }),
    (yt.sleepEvent = { type: "sleep" }),
    (yt.prototype.sleepTick = function (t) {
      if (this.allowSleep) {
        ...
        e === yt.AWAKE && i < o
          ? ((this.sleepState = yt.SLEEPY),
            (this.timeLastSleepy = t),
            this.dispatchEvent(yt.sleepyEvent))
          : e === yt.SLEEPY && i > o
          ? this.wakeUp()
          : e === yt.SLEEPY &&
            t - this.timeLastSleepy > this.sleepTimeLimit &&
            (this.sleep(), this.dispatchEvent(yt.sleepEvent));
      }
    }),
    (yt.prototype.updateSolveMassProperties = function () {
      this.sleepState === yt.SLEEPING || this.type === yt.KINEMATIC
        ? ((this.invMassSolve = 0),
    ...
    (yt.prototype.vectorToLocalFrame = function (t, e) {
      return (e = e || new ct()), this.quaternion.conjugate().vmult(t, e), e;
    }),
    ...
    (yt.prototype.vectorToWorldFrame = function (t, e) {
      return (e = e || new ct()), this.quaternion.vmult(t, e), e;
    });
  var ft = new ct(),
    mt = new y();
  (yt.prototype.addShape = function (t, e, i) {
    ...
    (yt.prototype.updateBoundingRadius = function () {
      for (
        var t = this.shapes, e = this.shapeOffsets, i = t.length, o = 0, n = 0;
        n !== i;
        n++
      ) {
        var r = t[n];
  ...
  (yt.prototype.updateMassProperties = function () {
    ...
    (yt.prototype.integrate = function (t, e, i) {
      if (
        ...
        (this.type === yt.DYNAMIC || this.type === yt.KINEMATIC) &&
          this.sleepState !== yt.SLEEPING)
      ) {
        var o = this.velocity,
          ...
          u = this.linearFactor,
          c = l * t;
        (o.x += s.x * c * u.x), (o.y += s.y * c * u.y), (o.z += s.z * c * u.z);
        var d = p.elements,
  ...
  var qt = e({}),
    Ct = i({});
  function Nt() {
    qt.call(this, { type: qt.types.PLANE }),
  ...
  e({}),
    ...
    (jt.prototype.needBroadphaseCollision = function (t, e) {
      return (
        ...
        ((0 == (t.type & ut.STATIC) && t.sleepState !== ut.SLEEPING) ||
          (0 == (e.type & ut.STATIC) && e.sleepState !== ut.SLEEPING))
      );
    }),
    (jt.prototype.intersectionTest = function (t, e, i, o) {
      this.useBoundingBoxes
        ? this.doBoundingBoxBroadphase(t, e, i, o)
        : this.doBoundingSphereBroadphase(t, e, i, o);
    });
  var It = new Pt();
  new Pt(),
    new y(),
    ...
    (jt.prototype.doBoundingBoxBroadphase = function (t, e, i, o) {
      t.aabbNeedsUpdate && t.computeAABB(),
        ...
        t.aabb.overlaps(e.aabb) && (i.push(t), o.push(e));
    });
  var Lt = { keys: [] },
    Ot = [],
    Wt = [];
  (jt.prototype.makePairsUnique = function (t, e) {
    ...
    for (t.length = 0, e.length = 0, s = 0; s !== r; s++) {
      var a = o[s].id,
        h = n[s].id;
      (i[(l = a < h ? a + "," + h : h + "," + a)] = s), i.keys.push(l);
    }
  ...
  (jt.boundingSphereCheck = function (t, e) {
    ...
    return (
      ...
      Math.pow(t.shape.boundingSphereRadius + e.shape.boundingSphereRadius, 2) >
        i.norm2()
    );
  }),
  ...
  var Ht = Gt,
    Ut = i({});
  function Gt() {
    (this.spatial = new Ut()), (this.rotational = new Ut());
  }
  ...
  o({}), (oe.prototype = new Dt()), (oe.prototype.constructor = oe);
  var ne = new ie(),
    re = new ie(),
    se = new ie();
  oe.prototype.computeB = function (t) {
    var e = this.a,
      ...
      l = o.velocity,
      p = o.angularVelocity,
      u = (o.force, o.torque, n.velocity),
      c = n.angularVelocity,
      d = (n.force, n.torque, se),
    ...
    return (
      -m * e -
      (w * u.dot(f) - w * l.dot(f) + c.dot(h) - p.dot(a)) * i -
      t * this.computeGiMf()
    );
  };
  var ae = new ie(),
  ...
  (xe.prototype.constructor = xe), (xe.CLOSEST = 1), (xe.ANY = 2), (xe.ALL = 4);
  var be = new h(),
    ge = [];
  xe.prototype.intersectWorld = function (t, e) {
    return (
      (this.mode = e.mode || xe.ANY),
  ...
  var Ee = new fe(),
    Be = new fe();
  function ze(t, e, i, o) {
    o.vsub(e, Xe), i.vsub(e, Ee), t.vsub(e, Be);
    var n,
      r,
      s = Xe.dot(Xe),
      a = Xe.dot(Ee),
      ...
      if (
        !(
          (function (t, e, i) {
            i.vsub(t, Xe);
            var o = Xe.dot(e);
            return e.mult(o, Ye), Ye.vadd(t, Ye), i.distanceTo(Ye);
  ...
  new fe(),
    ...
    (xe.prototype.intersectPlane = function (t, e, i, o, n) {
      ...
      r.vsub(i, l);
      var p = l.dot(h);
      if ((s.vsub(i, l), !(p * l.dot(h) > 0 || r.distanceTo(s) < p))) {
        var u = h.dot(a);
        if (!(Math.abs(u) < this.precision)) {
          ...
          r.vsub(i, c);
          var y = -h.dot(c) / u;
          a.scale(y, d), r.vadd(d, v), this.reportIntersection(h, v, n, o, -1);
        }
      }
    }),
  ...
  (xe.prototype.intersectHeightfield = function (t, e, i, o, n) {
    ...
    for (var d = s; d < l; d++)
      for (var v = a; v < p; v++) {
        ...
        if ((t.getAabbAtIndex(d, v, c), c.overlapsRay(r))) {
          if (
            (t.getConvexTrianglePillar(d, v, !1),
  ...
  (xe.prototype.intersectConvex = function (t, e, i, o, n, r) {
    for (
      ...
      var x = h ? h[w] : w,
        ...
        E = e,
        B = i;
      a.copy(p[b[0]]), E.vmult(a, a), a.vadd(B, a), a.vsub(d, a), E.vmult(g, s);
      var z = c.dot(s);
      if (!(Math.abs(z) < this.precision)) {
        ...
        if (!(A < 0)) {
          ...
          for (var F = 1; !m._shouldStop && F < b.length - 1; F++) {
            ...
            (!ze(Me, Se, qe, Ce) && !ze(Me, qe, Se, Ce)) ||
              M > y ||
              this.reportIntersection(s, Me, n, o, x);
          }
        }
      }
    }
  ...
  (xe.prototype.intersectTrimesh = function (t, e, i, o, n, r) {
    ...
    for (var b = 0, g = a.length; !this.result._shouldStop && b !== g; b++) {
      var E = a[b];
      t.getNormal(E, s), t.getVertex(y[3 * E], Se), Se.vsub(u, l);
      var B = p.dot(s),
        A = s.dot(l) / B;
      if (!(A < 0)) {
        p.scale(A, Me),
        ...
        (!ze(Me, qe, Se, Ce) && !ze(Me, Se, qe, Ce)) ||
          F > x ||
          (z.vectorToWorldFrame(e, s, v),
    ...
    (xe.prototype.reportIntersection = function (t, e, i, o, n) {
      ...
      if (!(this.skipBackfaces && t.dot(this._direction) > 0))
        switch (((h.hitFaceIndex = void 0 !== n ? n : -1), this.mode)) {
          case xe.ALL:
            (this.hasHit = !0),
              h.set(r, s, t, e, i, o, a),
              (h.hasHit = !0),
            ...
            break;
          case xe.CLOSEST:
            (a < h.distance || !h.hasHit) &&
              ((this.hasHit = !0), (h.hasHit = !0), h.set(r, s, t, e, i, o, a));
            break;
          case xe.ANY:
            (this.hasHit = !0),
              (h.hasHit = !0),
  ...
  o({}), (ni.prototype = new Dt()), (ni.prototype.constructor = ni);
  var ri = new oi(),
    si = new oi();
  ...
  (ci.prototype.createContactEquation = function (t, e, i, o, n, r) {
    ...
    return (
      h &&
        ...
        h.restitution >= 0 &&
        l.restitution >= 0 &&
        (s.restitution = h.restitution * l.restitution),
      (s.si = n || i),
      (s.sj = r || o),
      s
    );
  ...
  ci.prototype.createFrictionFromAverage = function (t) {
    ...
    if (
      ...
      di.setZero(), vi.setZero(), yi.setZero();
      for (var n = e.bi, r = (e.bj, 0); r !== t; r++)
        (e = this.result[this.result.length - 1 - r]).bodyA !== n
          ? (di.vadd(e.ni, di), vi.vadd(e.ri, vi), yi.vadd(e.rj, yi))
          : (di.vsub(e.ni, di), vi.vadd(e.rj, vi), yi.vadd(e.ri, yi));
      var s = 1 / t;
      vi.scale(s, i.ri),
        yi.scale(s, i.rj),
        o.ri.copy(i.ri),
  ...
  (ci.prototype.getContacts = function (t, e, i, o, n, r, s) {
    ...
    for (
      var a = wi, h = xi, l = fi, p = mi, u = 0, c = t.length;
      u !== c;
      u++
    ) {
      var d = t[u],
      ...
      d.material &&
        v.material &&
        (y = i.getContactMaterial(d.material, v.material) || null);
      for (
        var f =
            (d.type & ut.KINEMATIC && v.type & ut.STATIC) ||
            (d.type & ut.STATIC && v.type & ut.KINEMATIC) ||
            (d.type & ut.KINEMATIC && v.type & ut.KINEMATIC),
          m = 0;
        m < d.shapes.length;
        m++
      ) {
        ...
        for (var w = d.shapes[m], x = 0; x < v.shapes.length; x++) {
          ...
          var b = v.shapes[x];
          if (
            w.collisionFilterMask & b.collisionFilterGroup &&
            b.collisionFilterMask & w.collisionFilterGroup &&
            !(l.distanceTo(p) > w.boundingSphereRadius + b.boundingSphereRadius)
          ) {
            var g = null;
            w.material &&
              b.material &&
              (g = i.getContactMaterial(w.material, b.material) || null),
              (this.currentContactMaterial =
                g || y || i.defaultContactMaterial);
            var E = this[w.type | b.type];
            E &&
              (w.type < b.type
                ? E.call(this, w, b, l, p, a, h, d, v, w, b, f)
                : E.call(this, b, w, p, l, h, a, v, d, w, b, f)) &&
              f &&
              (i.shapeOverlapKeeper.set(w.id, b.id),
    ...
    (ci.prototype[hi.types.BOX | hi.types.BOX] = ci.prototype.boxBox =
      function (t, e, i, o, n, r, s, a, h, l, p) {
        return (
    ...
    (ci.prototype[hi.types.BOX | hi.types.CONVEXPOLYHEDRON] =
      ci.prototype.boxConvex =
        function (t, e, i, o, n, r, s, a, h, l, p) {
          return (
            (t.convexPolyhedronRepresentation.material = t.material),
            (t.convexPolyhedronRepresentation.collisionResponse =
    ...
    (ci.prototype[hi.types.BOX | hi.types.PARTICLE] = ci.prototype.boxParticle =
      function (t, e, i, o, n, r, s, a, h, l, p) {
        return (
          (t.convexPolyhedronRepresentation.material = t.material),
          (t.convexPolyhedronRepresentation.collisionResponse =
    ...
    (ci.prototype[hi.types.SPHERE] = ci.prototype.sphereSphere =
      function (t, e, i, o, n, r, s, a, h, l, p) {
  ...
  var bi = new li(),
    gi = new li(),
    Ei = new li();
  ci.prototype[hi.types.PLANE | hi.types.TRIMESH] = ci.prototype.planeTrimesh =
    function (t, e, i, o, n, r, s, a, h, l, p) {
      var u = new li(),
        c = bi;
      ...
      for (var d = 0; d < e.vertices.length / 3; d++) {
        e.getVertex(d, u);
        var v = new li();
        v.copy(u), z.pointToWorldFrame(o, r, v, u);
        var y = gi;
        if ((u.vsub(i, y), c.dot(y) <= 0)) {
          if (p) return !0;
  ...
  var Bi = new li(),
    ...
    Ii = new h(),
    Li = [];
  ci.prototype[hi.types.SPHERE | hi.types.TRIMESH] =
    ci.prototype.sphereTrimesh = function (t, e, i, o, n, r, s, a, h, l, p) {
      var u = Mi,
        c = Si,
        d = qi,
        v = Ci,
      ...
      for (var E = Ai, B = t.radius * t.radius, A = 0; A < b.length; A++)
        for (var F = 0; F < 3; F++)
          if (
            (e.getVertex(e.indices[3 * b[A] + F], E),
            E.vsub(y, x),
            x.norm2() <= B)
          ) {
            if ((w.copy(E), z.pointToWorldFrame(o, r, w, E), E.vsub(i, x), p))
              return !0;
      ...
      for (
        var C = Ri, N = Pi, T = ji, R = Bi, P = ((A = 0), b.length);
        A !== P;
        A++
      ) {
  ...
  var Oi = new li(),
    Wi = new li();
  ci.prototype[hi.types.SPHERE | hi.types.PLANE] = ci.prototype.spherePlane =
    function (t, e, i, o, n, r, s, a, h, l, p) {
      var u = this.createContactEquation(s, a, t, e, h, l);
      if (
        (u.ni.set(0, 0, 1),
  ...
  var Ui = new li(),
    ...
    Qi = new li(),
    Ji = new li();
  ci.prototype[hi.types.SPHERE | hi.types.BOX] = ci.prototype.sphereBox =
    function (t, e, i, o, n, r, s, a, h, l, p) {
      var u = this.v3pool,
        c = Yi;
      i.vsub(o, Ui), e.getSideNormals(c, r);
      for (
        var d = t.radius,
          v = !1,
          y = Ki,
        ...
        if (M < F + d && M > 0) {
          var S = Di,
            q = Xi;
          S.copy(c[(B + 1) % 3]), q.copy(c[(B + 2) % 3]);
          var C = S.norm(),
            N = q.norm();
          S.normalize(), q.normalize();
          var T = Ui.dot(S),
            R = Ui.dot(q);
          if (T < C && T > -C && R < N && R > -N) {
        ...
        for (W = 0; W !== U && !v; W++)
          if (O % 3 != W % 3) {
            c[W].cross(c[O], V),
              ...
              j.vsub(o, j);
            var G = j.dot(V);
            for (V.mult(G, H), k = 0; k === O % 3 || k === W % 3; ) k++;
            P.copy(i), P.vsub(H, P), P.vsub(_, P), P.vsub(o, P);
            var D = Math.abs(G),
              X = P.norm();
            if (D < c[k].norm() && X < d) {
              if (p) return !0;
  ...
  var $i = new li(),
    ...
    ao = new li(),
    ho = new li();
  (ci.prototype[hi.types.SPHERE | hi.types.CONVEXPOLYHEDRON] =
    ci.prototype.sphereConvex =
      function (t, e, i, o, n, r, s, a, h, l, p) {
        var u = this.v3pool;
        i.vsub(o, $i);
        for (
          ...
          var m = v[f],
            w = oo;
          r.vmult(m, w), o.vadd(w, w);
          var x = io;
          if ((w.vsub(i, x), x.norm2() < y * y))
            return (
              !!p ||
              ((b = !0),
        ...
        for (var b = !1, g = ((f = 0), d.length); f !== g && !1 === b; f++) {
          var E = c[f],
            B = d[f],
            z = no;
          r.vmult(E, z);
          var A = ro;
          r.vmult(v[B[0]], A), A.vadd(o, A);
          var F = so;
          z.mult(-y, F), i.vadd(F, F);
          var M = ao;
          F.vsub(A, M);
          var S = M.dot(z),
            q = ho;
          if ((i.vsub(A, q), S < 0 && q.dot(z) > 0)) {
            for (var C = [], N = 0, T = B.length; N !== T; N++) {
              var R = u.get();
              r.vmult(v[B[N]], R), o.vadd(R, R), C.push(R);
            }
            if (Hi(C, z, i)) {
              if (p) return !0;
              b = !0;
              var P = this.createContactEquation(s, a, t, e, h, l);
              z.mult(-y, P.ri), z.negate(P.ni);
              var j = u.get();
              z.mult(-S, j);
              var I = u.get();
              z.mult(-y, I),
                ...
                (N = 0);
              for (var L = C.length; N !== L; N++) u.release(C[N]);
              return;
            }
            for (N = 0; N !== B.length; N++) {
              ...
              i.vsub(O, H);
              var U = H.dot(V);
              V.mult(U, _), _.vadd(O, _);
              var G = u.get();
              if (
                (_.vsub(i, G), U > 0 && U * U < k.norm2() && G.norm2() < y * y)
              ) {
                if (p) return !0;
                for (
                  P = this.createContactEquation(s, a, t, e, h, l),
                    _.vsub(o, P.rj),
                    _.vsub(i, P.ni),
                    P.ni.normalize(),
                    P.ni.mult(y, P.ri),
            ...
            for (N = 0, L = C.length; N !== L; N++) u.release(C[N]);
          }
        }
      }),
    new li(),
    new li(),
    (ci.prototype[hi.types.PLANE | hi.types.BOX] = ci.prototype.planeBox =
      function (t, e, i, o, n, r, s, a, h, l, p) {
        return (
          (e.convexPolyhedronRepresentation.material = e.material),
          (e.convexPolyhedronRepresentation.collisionResponse =
  ...
  var lo = new li(),
    ...
    uo = new li(),
    co = new li();
  ci.prototype[hi.types.PLANE | hi.types.CONVEXPOLYHEDRON] =
    ci.prototype.planeConvex = function (t, e, i, o, n, r, s, a, h, l, p) {
      var u = lo,
        c = po;
      c.set(0, 0, 1), n.vmult(c, c);
  ...
  var vo = new li(),
    yo = new li();
  ci.prototype[hi.types.CONVEXPOLYHEDRON] = ci.prototype.convexConvex =
    function (t, e, i, o, n, r, s, a, h, l, p, u, c) {
      var d = vo;
      if (
        !(i.distanceTo(o) > t.boundingSphereRadius + e.boundingSphereRadius) &&
        t.findSeparatingAxis(e, i, n, o, r, d, u, c)
      ) {
        var v = [],
          y = yo;
  ...
  var fo = new li(),
    mo = new li(),
    wo = new li();
  ci.prototype[hi.types.PLANE | hi.types.PARTICLE] =
    ci.prototype.planeParticle = function (t, e, i, o, n, r, s, a, h, l, p) {
      var u = fo;
      u.set(0, 0, 1), s.quaternion.vmult(u, u);
      var c = mo;
      if ((o.vsub(s.position, c), u.dot(c) <= 0)) {
        if (p) return !0;
  ...
  var xo = new li();
  ci.prototype[hi.types.PARTICLE | hi.types.SPHERE] =
    ci.prototype.sphereParticle = function (t, e, i, o, n, r, s, a, h, l, p) {
      var u = xo;
  ...
  var bo = new pi(),
    ...
    Bo = new li(),
    zo = new li();
  (ci.prototype[hi.types.PARTICLE | hi.types.CONVEXPOLYHEDRON] =
    ci.prototype.convexParticle =
      function (t, e, i, o, n, r, s, a, h, l, p) {
        var u = -1,
          c = Eo,
          d = zo,
    ...
    (ci.prototype[hi.types.BOX | hi.types.HEIGHTFIELD] =
      ci.prototype.boxHeightfield =
        function (t, e, i, o, n, r, s, a, h, l, p) {
          return (
            (t.convexPolyhedronRepresentation.material = t.material),
            (t.convexPolyhedronRepresentation.collisionResponse =
  ...
  var Ao = new li(),
    Fo = new li(),
    Mo = [0];
  ci.prototype[hi.types.CONVEXPOLYHEDRON | hi.types.HEIGHTFIELD] =
    ci.prototype.convexHeightfield = function (
      t,
      e,
      i,
      o,
        ...
        if (!(f.z - d > B || f.z + d < E))
          for (var A = m; A < w; A++)
            for (var F = x; F < b; F++) {
              var M = !1;
              if (
                (e.getConvexTrianglePillar(A, F, !1),
                ...
                return !0;
              if (
                (e.getConvexTrianglePillar(A, F, !0),
                z.pointToWorldFrame(o, r, e.pillarOffset, v),
                i.distanceTo(v) <
                  e.pillarConvex.boundingSphereRadius +
                    t.boundingSphereRadius &&
  ...
  var So = new li(),
    qo = new li();
  ci.prototype[hi.types.SPHERE | hi.types.HEIGHTFIELD] =
    ci.prototype.sphereHeightfield = function (
      t,
      e,
      i,
      o,
  ...
  (Io.prototype = new jo()), (Io.prototype.constructor = Io);
  var Lo = new Po(),
    Oo = new Po();
  ...
  (_o.prototype = new Vo()), (_o.prototype.constructor = _o);
  var Ho = new ko(),
    Uo = new ko();
  _o.prototype.computeB = function (t) {
    ...
    return (
      ...
      a.rotational.copy(s),
      h.rotational.copy(r),
      -(Math.cos(this.maxAngle) - o.dot(n)) * e -
        this.computeGW() * i -
        t * this.computeGiMf()
    );
  };
  ...
  var Jo = $o;
  function $o() {
    Ze.call(this), (this.iterations = 10), (this.tolerance = 1e-7);
  }
  i({}), ($o.prototype = new Ze());
  var tn = [],
    en = [],
    on = [];
  $o.prototype.solve = function (t, e) {
    var i,
      ...
      d = c.length,
      v = t;
    if (0 !== u) for (var y = 0; y !== d; y++) c[y].updateSolveMassProperties();
    var f = en,
      m = on,
      w = tn;
    for (f.length = u, m.length = u, w.length = u, y = 0; y !== u; y++) {
      var x = p[y];
      (w[y] = 0), (m[y] = x.computeB(v)), (f[y] = 1 / x.computeC());
    }
    if (0 !== u) {
      for (y = 0; y !== d; y++) {
        var b = (B = c[y]).vlambda,
          g = B.wlambda;
        b.set(0, 0, 0), g.set(0, 0, 0);
      }
      for (a = 0; a !== h; a++) {
        r = 0;
        for (var E = 0; E !== u; E++)
          (x = p[E]),
            (i = m[E]),
            (o = f[E]),
            (s = w[E]) + (n = o * (i - x.computeGWlambda() - x.eps * s)) <
            x.minForce
              ? (n = x.minForce - s)
              : s + n > x.maxForce && (n = x.maxForce - s),
            (w[E] += n),
            (r += n > 0 ? n : -n),
            x.addToWlambda(n);
        if (r * r < l) break;
      ...
      for (var F = p.length, M = 1 / v; F--; ) p[F].multiplier = w[F] * M;
    }
    return a;
  };
  var nn = an,
  ...
  function an(t, e, i, o, n) {
    ...
    if (r <= 0) throw "GridBroadphase: Each dimension's n must be >0";
    (this.bins = []),
      (this.binLengths = []),
      (this.bins.length = r),
      (this.binLengths.length = r);
    for (var s = 0; s < r; s++) (this.bins[s] = []), (this.binLengths[s] = 0);
  }
  (an.prototype = new Rt()), (an.prototype.constructor = an);
  var hn = new rn();
  new rn(),
    (an.prototype.collisionPairs = function (t, e, i) {
      for (
        var o = t.numObjects(),
          ...
          B = (v - m) / h,
          z = (y - w) / l,
          A = 0.5 * Math.sqrt(E * E + B * B + z * z),
          F = sn.types,
          M = F.SPHERE,
          S = F.PLANE,
          q = (F.BOX, F.COMPOUND, F.CONVEXPOLYHEDRON, this.bins),
          C = this.binLengths,
          N = this.bins.length,
          T = 0;
        T !== N;
      ...
      for (s = Math.min, r = Math.max, T = 0; T !== o; T++) {
        var j = (tt = n[T]).shape;
        switch (j.type) {
          case M:
            var I = tt.position.x,
          ...
          case S:
            ...
            var k = j.worldNormal,
              V = f + 0.5 * E - tt.position.x,
              _ = m + 0.5 * B - tt.position.y,
              H = w + 0.5 * z - tt.position.z,
              U = hn;
            U.set(V, _, H);
            for (var G = 0, D = 0; G !== a; G++, D += p, U.y = _, U.x += E)
              for (var X = 0, Y = 0; X !== h; X++, Y += u, U.z = H, U.y += B)
                for (var Z = 0, K = 0; Z !== l; Z++, K += c, U.z += z)
                  if (U.dot(k) < A) {
                    var Q = D + Y + K;
                    q[Q][C[Q]++] = tt;
                  }
          ...
          default:
            tt.aabbNeedsUpdate && tt.computeAABB(),
              P(
                tt.aabb.lowerBound.x,
                tt.aabb.lowerBound.y,
                tt.aabb.lowerBound.z,
                tt.aabb.upperBound.x,
                tt.aabb.upperBound.y,
                tt.aabb.upperBound.z,
                tt
              );
        }
      }
      for (T = 0; T !== N; T++) {
        ...
        if (J > 1) {
          ...
          for (G = 0; G !== J; G++) {
            ...
            for (X = 0; X !== G; X++) {
              var et = $[X];
              this.needBroadphaseCollision(tt, et) &&
                this.intersectionTest(tt, et, e, i);
            }
          }
        }
      }
  ...
  function yn(t, e, i) {
    ...
    (h.enabled = !1), this.equations.push(s, a, h);
  }
  (yn.prototype = new Co()),
    (yn.constructor = yn),
    ...
    (En.prototype.collisionPairs = function (t, e, i) {
      ...
      for (o = 0; o !== h; o++)
        for (n = 0; n !== o; n++)
          (r = a[o]),
            (s = a[n]),
            this.needBroadphaseCollision(r, s) &&
              this.intersectionTest(r, s, e, i);
    }),
    new h(),
  ...
  e({}),
    ...
    (Fn.insertionSortX = function (t) {
      for (var e = 1, i = t.length; e < i; e++) {
        for (
          var o = t[e], n = e - 1;
          n >= 0 && !(t[n].aabb.lowerBound.x <= o.aabb.lowerBound.x);
          n--
        )
          t[n + 1] = t[n];
        t[n + 1] = o;
    ...
    (Fn.insertionSortY = function (t) {
      for (var e = 1, i = t.length; e < i; e++) {
        for (
          var o = t[e], n = e - 1;
          n >= 0 && !(t[n].aabb.lowerBound.y <= o.aabb.lowerBound.y);
          n--
        )
          t[n + 1] = t[n];
        t[n + 1] = o;
    ...
    (Fn.insertionSortZ = function (t) {
      for (var e = 1, i = t.length; e < i; e++) {
        for (
          var o = t[e], n = e - 1;
          n >= 0 && !(t[n].aabb.lowerBound.z <= o.aabb.lowerBound.z);
          n--
        )
          t[n + 1] = t[n];
        t[n + 1] = o;
    ...
    (Fn.prototype.collisionPairs = function (t, e, i) {
      var o,
        ...
        a = this.axisIndex;
      for (
        this.dirty && (this.sortList(), (this.dirty = !1)), o = 0;
        o !== s;
        o++
      ) {
        var h = r[o];
    ...
    (Fn.prototype.sortList = function () {
      for (
        var t = this.axisList, e = this.axisIndex, i = t.length, o = 0;
        o !== i;
        o++
      ) {
        var n = t[o];
      ...
      0 === e
        ...
        : 1 === e
        ? Fn.insertionSortY(t)
        : 2 === e && Fn.insertionSortZ(t);
    }),
    (Fn.checkBounds = function (t, e, i) {
      var o, n;
      0 === i
        ? ((o = t.position.x), (n = e.position.x))
        : 1 === i
        ? ((o = t.position.y), (n = e.position.y))
        : 2 === i && ((o = t.position.z), (n = e.position.z));
    ...
    (Fn.prototype.aabbQuery = function (t, e, i) {
      ...
      1 === o && (n = "y"), 2 === o && (n = "z");
      for (
        var r = this.axisList, s = (e.lowerBound[n], e.upperBound[n], 0);
        s < r.length;
        s++
      ) {
        var a = r[s];
  ...
  function Cn(t) {
    if (
      (Sn.call(this, { type: Sn.types.SPHERE }),
  ...
  function Ln(t) {
    for (var e = t.length, i = 0; i !== e; i++) {
      var o = t[i];
      if (!(o.visited || o.body.type & In)) return o;
    }
    return !1;
  }
  var On = [];
  function Wn(t, e, i, o) {
    for (On.push(t), t.visited = !0, e(t, i, o); On.length; )
      for (var n, r = On.pop(); (n = Ln(r.children)); )
        (n.visited = !0), e(n, i, o), On.push(n);
  }
  function kn(t, e, i) {
    e.push(t.body);
  ...
  (Tn.prototype.createNode = function () {
    ...
    (Tn.prototype.solve = function (t, e) {
      ...
      for (var u = 0; u !== s; u++) {
        var c = r[u],
          d = ((l = n.indexOf(c.bi)), n.indexOf(c.bj)),
          v = i[l],
          y = i[d];
        v.children.push(y), v.eqs.push(c), y.children.push(v), y.eqs.push(c);
      }
      var f,
        m = 0,
        w = Pn;
      ...
      for (var x = jn; (f = Ln(i)); ) {
        (w.length = 0), (x.bodies.length = 0), Wn(f, kn, x.bodies, w);
        var b = w.length;
        for (w = w.sort(Vn), l = 0; l !== b; l++) h.addEquation(w[l]);
        h.solve(t, x), h.removeAllEquations(), m++;
      }
      return m;
    });
  var _n = {};
  ...
  (_n = Hn),
    ...
    (Hn.prototype.getDiff = function (t, e) {
      for (
        ...
        for (var h = i[a]; h > o[s]; ) s++;
        h === o[s] || Un(t, h);
      }
      for (s = 0, a = 0; a < r; a++) {
        for (var l = o[a]; l > i[s]; ) s++;
        i[s] === l || Un(e, l);
      }
    });
  var Gn = {};
  ...
  function Kn(t) {
    (t = t || {}),
      ...
      (this.defaultContactMaterial = new Yo(
  ...
  (Kn.prototype = new d()), new h();
  var Qn = new ye();
  if (
    ((Kn.prototype.getContactMaterial = function (t, e) {
    ...
    (Kn.prototype.add = Kn.prototype.addBody =
      function (t) {
    ...
    performance.timing &&
      ...
      (Jn = performance.timing.navigationStart),
    ...
    (Kn.prototype.step = function (t, e, i) {
      if (((i = i || 10), 0 === (e = e || 0)))
        ...
        for (var o = 0; this.accumulator >= t && o < i; )
          this.internalStep(t), (this.accumulator -= t), o++;
        for (
          var n = (this.accumulator % t) / t, r = 0;
  ...
  var $n,
    ...
    rr = { type: "postStep" },
    sr = { type: "preStep" },
    ar = { type: ut.COLLIDE_EVENT_NAME, body: null, contact: null },
    hr = [],
    lr = [],
    pr = [],
    ur = [];
  return (
    ...
    (Kn.prototype.internalStep = function (t) {
      ...
      var e,
        ...
        f = h.z,
        m = 0;
      for (l && (e = performance.now()), m = 0; m !== r; m++)
        if ((S = s[m]).type === u) {
          var w = S.force,
            x = S.mass;
          (w.x += x * v), (w.y += x * y), (w.z += x * f);
        }
      m = 0;
      ...
      for (m = 0; m !== g; m++)
        if (!(T = c[m]).collideConnected)
          for (var E = o.length - 1; E >= 0; E -= 1)
            ((T.bodyA === o[E] && T.bodyB === n[E]) ||
              (T.bodyB === o[E] && T.bodyA === n[E])) &&
              (o.splice(E, 1), n.splice(E, 1));
      this.collisionMatrixTick(), l && (e = performance.now());
      var B = hr,
        z = i.length;
      for (m = 0; m !== z; m++) B.push(i[m]);
      i.length = 0;
      var A = this.frictionEquations.length;
      for (m = 0; m !== A; m++) d.push(this.frictionEquations[m]);
      for (
        this.frictionEquations.length = 0,
          ...
          l && (e = performance.now()),
          m = 0;
        m < this.frictionEquations.length;
        m++
      )
      ...
      for (var F = i.length, M = 0; M !== F; M++) {
        ...
        (
          (S.material &&
            q.material &&
            this.getContactMaterial(S.material, q.material)) ||
          this.defaultContactMaterial
        ).friction,
          S.material &&
            q.material &&
            (S.material.friction >= 0 &&
              q.material.friction >= 0 &&
              (S.material.friction, q.material.friction),
            S.material.restitution >= 0 &&
              q.material.restitution >= 0 &&
              (T.restitution =
                S.material.restitution * q.material.restitution)),
          a.addEquation(T),
          S.allowSleep &&
            S.type === ut.DYNAMIC &&
            S.sleepState === ut.SLEEPING &&
            q.sleepState === ut.AWAKE &&
            q.type !== ut.STATIC &&
            q.velocity.norm2() + q.angularVelocity.norm2() >=
              2 * Math.pow(q.sleepSpeedLimit, 2) &&
            (S._wakeUpAfterNarrowphase = !0),
          q.allowSleep &&
            q.type === ut.DYNAMIC &&
            q.sleepState === ut.SLEEPING &&
            S.sleepState === ut.AWAKE &&
            S.type !== ut.STATIC &&
            S.velocity.norm2() + S.angularVelocity.norm2() >=
              2 * Math.pow(S.sleepSpeedLimit, 2) &&
            (q._wakeUpAfterNarrowphase = !0),
          this.collisionMatrix.set(S, q, !0),
          this.collisionMatrixPrevious.get(S, q) ||
            ((ar.body = q),
            (ar.contact = T),
            S.dispatchEvent(ar),
            (ar.body = S),
      ...
      for (
        this.emitContactEvents(),
          l &&
            ((p.makeContactConstraints = performance.now() - e),
            (e = performance.now())),
          m = 0;
        m !== r;
        m++
      )
        (S = s[m])._wakeUpAfterNarrowphase &&
    ...
    (Kn.prototype.emitContactEvents =
      (($n = []),
      (tr = []),
      (er = { type: "beginContact", bodyA: null, bodyB: null }),
      (ir = { type: "endContact", bodyA: null, bodyB: null }),
      (or = {
      ...
      function () {
        ...
        if (((t || e) && this.bodyOverlapKeeper.getDiff($n, tr), t)) {
        ...
        if (((n || r) && this.shapeOverlapKeeper.getDiff($n, tr), n)) {
          for (i = 0, o = $n.length; i < o; i += 2) {
